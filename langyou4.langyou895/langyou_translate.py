...
# -*- coding: utf-8 -*-
"""
Langyou Translate (luong DICH rieng)
====================================
Theo doi langyou4.langyou895/txt/origin/*.json (ban goc do langyou_downloader.py
--no-translate tao ra), dich sang tieng Viet + chong trung registry, luu ra
langyou4.langyou895/txt/.  Chay SONG SONG voi luong tai (2 cua so):

  Cua so 1 (lay truyen, nhanh):
      py -u langyou_downloader.py --wd 母子 --no-translate
  Cua so 2 (dich, chay lien tuc):
      py -u langyou_translate.py --engine caiyun --workers 5

Tai dung toan bo logic dich + chong trung cua sosing_downloader (registry
check_and_update, translate, write) va cac duong dan cua langyou_downloader.
...
import langyou_downloader as ld      # duong dan TXT_DIR / ORIGIN_DIR + fetch config
...
def main():
    ap = argparse.ArgumentParser(description="Luong dich rieng cho langyou (JSON goc -> txt Viet)")
